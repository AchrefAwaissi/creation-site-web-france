...
//     emailjs.send(
//       'service_b9udk6s',          // Ton ID de service
//       'template_7tuo67n',         // Ton ID de template
//       formData,
...
//   return (
//     <form onSubmit={sendEmail} className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md space-y-4">
//       <h2 className="text-2xl font-bold text-center text-gray-800">Contactez-moi</h2>
